...
void search_phone(struct blood *, int);
...
//Search by phone
void search_phone(struct blood *b, int n)
{
    int phone;
    int found=0;
    system("cls");
...
void delete(struct blood *b,int n)
{
    ...
    {   
        ...
        {         
            ...
            fwrite(&b[j],sizeof(struct blood),1,fp1);                  
        }        
    }
        i=i+1;
